...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/DBVbox/Vbox.git
   cd Vbox
   ```
2. **Install MonoSAT:**
   ```bash
...
We implemented a log generator called **[Vgen](https://github.com/DBVbox/Vgen.git)** to generate transaction logs in the Vbox format. You can refer to the **Vgen** code for more details on how to generate logs for various types of transaction histories.
